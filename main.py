...
Original file is located at
    https://colab.research.google.com/drive/1WP0xM_RNUpuDDzz0HT76Z8t6wqK9-sKR
...
df = pd.read_csv('/content/drive/My Drive/breast-cancer.csv')
...
import pickle
model = svc
pickle.dump(model, open("/content/drive/My Drive/breast_cancer.pkl",'wb'))
...
plt.savefig("/content/drive/My Drive/roc_breast_cancer.jpeg", format='jpeg', dpi=400, bbox_inches='tight')
plt.show()
...
plt.savefig("/content/drive/My Drive/PE_breast_cancer.jpeg", format='jpeg', dpi=400, bbox_inches='tight')
plt.show()
